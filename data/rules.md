...
1. Generate initiative.

2. Generate event.

3. Draw tokens from your bag until you reach your hand size.
...
- Leaders must move 2 spaces according to the dance pattern
...
- Nobles may move as they please.  Collision rules are reversed for unpartnered nobles; if a model collides with an unpartnered noble, the unpartnered noble is the one whose player suffers -1 hand size.

## Tests

- If a test is required, players roll 2d6 and add their appropriate stat and any other modifiers.  If they total 7 or higher, they succeed.

## Other Effects:

Hand and draw size can only be modified down to a minimum of 1.  If hand size is decreased mid round, you must discard at the end of that round.

#### Hand Size

- -1 if a friendly noble collides with someone

#### Draw Size

- -1 if cannot partner with a new noble during a song change

- -1 if, after drawing a token, your hand is all chatter or misinformation
